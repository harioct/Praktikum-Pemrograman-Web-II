                ...
                <div class="col-sm-5 mx-auto">
                    <form method="POST">
                        <div class="mb-3 mt-3">
                            ...
                            <input type="text" name="id_buku" value="<?php echo $data['id_buku']; ?>" placeholder="Masukkan ID Buku" required class="form-control col-form-label-sm">
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Judul</label>
                            <input type="text" name="judul_buku" value="<?php echo $data['judul_buku']; ?>" placeholder="Masukkan Judul Buku" required class="form-control col-form-label-sm">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" name="tahun_terbit" value="<?php echo $data['tahun_terbit']; ?>" placeholder="Masukkan Tahun Terbit" required class="form-control col-form-label-sm" min="1900" max="2099">
                        </div>
                ...
                <div class="col-sm-5 mx-auto">
                    <form method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="judul_buku" placeholder="Masukkan Judul Buku" required class="form-control col-form-label-sm">
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Penulis</label>
                        ...
                        <div class="mb-3">
                            <label class="form-label">Tahun Terbit</label>
                            <input type="number" name="tahun_terbit" placeholder="Masukkan Tahun Terbit" required class="form-control col-form-label-sm" min="1900" max="2099">
                        </div>
